...
hd2 = HandDetector(maxHands=1,detectionCon=0.7)
...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="Conversion Sign Language To Text And Voice", font=("Courier", 30, "bold"))
 ...
 #               if lenn >= 1:
  #                  self.word1 = ddd.suggest(word)[0]
   #         else:
    ...
    def run(self):
        """Explicitly run the Tkinter mainloop."""
        self.root.mainloop()
